...
*/
bool IsContainedIn(const GuillotineBinPack::Rect &a, const GuillotineBinPack::Rect &b)
{
...
bool Fits(const GuillotineBinPack::RectSize &r, const GuillotineBinPack::Rect &freeRect)
{
...
bool FitsPerfectly(const GuillotineBinPack::RectSize &r, const GuillotineBinPack::Rect &freeRect)
{
	return (r.width == freeRect.width && r.height == freeRect.height) ||
		(r.height == freeRect.width && r.width == freeRect.height);
}
...
GuillotineBinPack::Rect GuillotineBinPack::Insert(int width, int height, bool merge, FreeRectChoiceHeuristic rectChoice, 
...
GuillotineBinPack::Rect GuillotineBinPack::FindPositionForNewNode(int width, int height, FreeRectChoiceHeuristic rectChoice, int *nodeIndex)
{
	Rect bestNode;
